...
REM
REM Generated by Vivado on Thu Feb 19 20:11:52 +0530 2026
...
echo "xvlog --incr --relax -prj tb_top_enc_vlog.prj"
call xvlog  --incr --relax -prj tb_top_enc_vlog.prj -log xvlog.log
